...
bl_info = {
    "name": "ksEditor-compatible-FBX format",
    "author": "Campbell Barton, Bastien Montagne, Jens Restemeier, FFD",
    "version": (0, 2, 1),
    "blender": (2, 83, 0),
    "location": "File > Import-Export",
    "description": "ksEditor-compatible FBX export.",
    "warning": "",
    "wiki_url": "",
    "tracker_url": "",
    "support": 'TESTING',
...
from .kn5_sanitizer import del_name_dot_index #rem

#rem edited import defaults
...
def menu_func_import(self, context):
    self.layout.operator(ImportFBX.bl_idname, text="kn5Unpack-ed FBX (.fbx)")


def menu_func_export(self, context):
    self.layout.operator(ExportFBX.bl_idname, text="kn5-compatible FBX (.fbx)")
